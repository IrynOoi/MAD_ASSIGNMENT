...
-run python activity03_mapping.py for data mapping part in terminal of vs code
note:use ur own gemini api key becuz every gemini api key got its own usage limit,if 3 ppl access same api key might have issue ltr
